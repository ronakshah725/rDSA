 ...
 * 
 * 
 * 1. When new elements are added, add to both deque back and treeMap
 * 2. When size of deque == k, minDiff 
 * When size of deque > k, remove from deque front
 * @param arr
 * @param k
 * @return
 */
    private static int findMinDiff(int[] arr, int k) {
